...
public class ListTasks {
    // Есть список с именами. Написать метод возвращаюший лист без имен длиной 4 символа
    ...
    public List<String> removeNamesLength4(List<String> names){
        ...
        return res;
       // Есть два списка одинаковой длинны с целыми числами.
        // Написать метод, который возвращает список с элементами Yes или No,
    ...
    // Написать метод который реверсирует лист т.е возвращает список элементов в обратном порядке
    // [1,2,3,4,5]  -> [5,4,3,2,1]
